...
app.config(['$routeProvider', function ($routeProvider) {
  $routeProvider.
    ...
    when('/students', {
        templateUrl: 'partials/studentsWithDirective.html',
        controller: 'StudentController'
    }).
    otherwise({
        redirectTo: '/'
...
// I know that using the filter isn't working correctly when it's not hidden. Having an issue with scope for transcluded HTML. Will upload a new version once I figure it out.
